...
router.post('/fetchnode',function(req,res){

    console.log("Inside get node Post Request");

    //var sql = "select id_sensor_master_pk, sensor_type, node_id_fk, sensor_model, sensor_make , status from sensor_master";
    var sql = "select * from node_master";
            ...
            con.query(sql,function(err,result){
                if(err){
                    ...
                    if(result.length === 0){
                        ...
                        console.log("Successful fetched node data");
                    }
                }
            });
        }
