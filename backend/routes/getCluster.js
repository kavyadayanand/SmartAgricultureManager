...
router.post('/getCluster',function(req,res){

    console.log("Inside get cluster by id Request", req.body.uclusterID);

    //var sql = "select id_sensor_master_pk, sensor_type, node_id_fk, sensor_model, sensor_make , status from sensor_master";
    var sql = "select * from cluster_master where id_cluster_master_pk = " +parseInt(req.body.uclusterID);
    console.log(sql)
